<x-admin-layout>
    <x-slot name="title">Novo Plano</x-slot>
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-gray-800 rounded-xl p-6">
            <h2 class="text-xl font-bold text-white mb-6">Criar Novo Plano</h2>
            ...
            <form action="{{ route('admin.plans.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        value="{{ old('slug') }}"
                        class="w-full bg-gray-700 border-gray-600 text-white rounded-lg focus:ring-red-500 focus:border-red-500"
                        placeholder="mensal (gerado automaticamente)"
                    >
                    @error('slug')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <textarea 
                        ...
                        rows="5"
                        class="w-full bg-gray-700 border-gray-600 text-white rounded-lg focus:ring-red-500 focus:border-red-500"
                        placeholder="Acesso a todos os vídeos&#10;Novos treinos toda semana&#10;Suporte via WhatsApp"
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-5 h-5 bg-gray-700 border-gray-600 rounded text-red-600 focus:ring-red-500">
